...
export const { setSearchTerm, setSelectedCategory, setSelectedAuthor, setCategories, setSort } = globalSlice.actions;
...
export const store = configureStore({
  ...
  middleware: getDefaultMiddleware => getDefaultMiddleware().concat(dwsApi.middleware),
});
